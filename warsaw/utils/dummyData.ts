...
export const dummyProfile: Profile = {
  icon: {
    foreground: IconForegroundKey.PIRATE,
    background: IconBackgroundKey.BLACK,
  },
  personalInfo: {
    name: 'Ash',
    pronouns: 'they/them',
...
export const dummyUserDatabase = {
  ...
  user2: {
    ...
    profile: {
      ...
      icon: {
        foreground: IconForegroundKey.BOOK,
  ...
  user8: {
    ...
    profile: {
      ...
      icon: {
        foreground: IconForegroundKey.TANGERINE,
        background: IconBackgroundKey.BLUE,
      },
    },
    likes: [],
  ...
  user9: {
    ...
    profile: {
      ...
      icon: {
        foreground: IconForegroundKey.SKULL,
